...
const PrivacyPolicy = () => {
    ...
    const privacyMessages = [
        "Your privacy matters, Beautiful! 🔒✨",
        "We've got your back, Queen! 💎",
        "Your data is safe with us! 👑💕",
        "Privacy is luxury, gorgeous! 🌟",
        "We protect what matters! 💖",
        "Trust is our foundation, Beautiful! ✨"
    ];
    ...
    useEffect(() => { 
        setTimeout(() => {
            const randomMessage = privacyMessages[Math.floor(Math.random() * privacyMessages.length)];
